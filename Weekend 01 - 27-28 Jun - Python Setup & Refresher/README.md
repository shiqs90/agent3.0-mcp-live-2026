...
```mermaid
flowchart LR
    A["🐍 Class 01, Sat 27 Jun<br/>Dev environment + fundamentals"] --> B["🧱 Class 02, Sun 28 Jun<br/>OOP, decorators, error handling"]
    B -.continues into.-> C["🛡️ Class 03, Sat 4 Jul<br/>Pydantic Deep Dive — Weekend 02"]
