...
```mermaid
flowchart LR
    A["🤖 Class 11, Sat 1 Aug<br/>Weekend 06"] -.continues from.-> B["🧵 Class 12, Sat–Sun 8-9 Aug<br/>Mastering Middleware"]
    style A fill:#e5e7eb
...
|---|---|---|---|
| 12 | Mastering Middleware: Limits, Fallback, PII, Retry & Tool Emulation | [classes_summary →](<../classes_summary/12 - 08 Aug - Mastering Middleware.md>) | [`11-12 .../`](<../Weekend 06 - 1 Aug - Agents, Memory & Middleware/11-12 - 1-8 Aug - Agents, Memory & Middleware/>) (`MIddleware.ipynb` cells 57–end) — lives in [Weekend 06](<../Weekend 06 - 1 Aug - Agents, Memory & Middleware/README.md>) |
...
> ℹ️ **Shared code folder:** this class's code lives in `11-12 .../` inside **[Weekend 06](<../Weekend 06 - 1 Aug - Agents, Memory & Middleware/README.md>)** (continuous with Class 11).

## 🔁 Weekend Navigation

⬅️ [Weekend 06 — 1 Aug](<../Weekend 06 - 1 Aug - Agents, Memory & Middleware/README.md>) · ⬆️ [Course index](<../README.md>)
