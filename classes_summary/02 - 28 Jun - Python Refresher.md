...
> 📂 **Code for this class:** [`02-03 - 28 Jun & 4 Jul - Python Refresher & Pydantic Deep Dive/`](<../02-03 - 28 Jun & 4 Jul - Python Refresher & Pydantic Deep Dive/>) — files `_0` through `_4`, an expanded 15-file codebase that carries this same numbering all the way through Class 05's agent-with-memory

---

## 🏛️ Object-Oriented Python — The Bank Account Example

The real file, [`_2_oop_classes.py`](<../02-03 - 28 Jun & 4 Jul - Python Refresher & Pydantic Deep Dive/_2_oop_classes.py>), opens with a comment that sets up the entire class's arc: *"Class 1 only ever showed you a class wearing an 'Agent' costume; this file is the bare pattern, on its own, so it actually generalizes."*
...
[`_4_decorators.py`](<../02-03 - 28 Jun & 4 Jul - Python Refresher & Pydantic Deep Dive/_4_decorators.py>) builds two decorators, then stacks them:
...
| File | Covers |
|---|---|
| [`_0_basics_refresher.py`](<../02-03 - 28 Jun & 4 Jul - Python Refresher & Pydantic Deep Dive/_0_basics_refresher.py>) | Quick Class 01 recap — variables, f-strings, `if`/`elif`/`else` |
| [`_1_data_structures.py`](<../02-03 - 28 Jun & 4 Jul - Python Refresher & Pydantic Deep Dive/_1_data_structures.py>) | Lists, tuple unpacking, dicts, and the pattern that matters most later: a **list of dicts** |
| [`_2_oop_classes.py`](<../02-03 - 28 Jun & 4 Jul - Python Refresher & Pydantic Deep Dive/_2_oop_classes.py>) | `BankAccount`, `Book` — plain classes, then the `@dataclass` shortcut |
| [`_3_error_handling.py`](<../02-03 - 28 Jun & 4 Jul - Python Refresher & Pydantic Deep Dive/_3_error_handling.py>) | `try`/`except`/`finally`, multiple exception types, tied back to a missing dict key |
| [`_4_decorators.py`](<../02-03 - 28 Jun & 4 Jul - Python Refresher & Pydantic Deep Dive/_4_decorators.py>) | The wrapper pattern, generic, then stacked (`@announce` `@timed`) |
