...
```mermaid
flowchart LR
    A["🌱 Traditional Path<br/>Data Science → GenAI → Agentic AI"] --> D{Your<br/>Experience}
    B["⚙️ Modern Path<br/>Some experience"] --> D
    C["⚡ Advanced Path<br/>Highly experienced"] --> D
    D --> E["🎯 Agentic AI 3.0<br/>(Modern + Advanced blend)"]
...
```mermaid
flowchart TD
    S1["📚 Foundations<br/>LLMs, tokens, providers"] --> S2["🧩 Core Frameworks<br/>LangChain • LangGraph • MCP • A2A • RAG"]
    S2 --> S3["🛠️ Mini-Projects"] --> S4["☁️ Interim Projects<br/>deployed on Cloud & VPS"]
    S4 --> S5["🤖 Coding Agent Ecosystem<br/>Claude Code • Hermes/Nemo"] --> S6["🔗 Extended Frameworks<br/>ADK • Claude Agent SDK"]
    S6 --> S7["🏗️ Production Capstones<br/>~9 real-world builds"]

    style S3 fill:#fca5a5,stroke:#ef4444
    style S7 fill:#6ee7b7,stroke:#10b981
```
...
---
*Part of the [Live-Class-2026](../README.md) class summary index.*
